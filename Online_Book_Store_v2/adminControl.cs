...
namespace Online_Book_Store_v2
{
    ...
    public partial class adminControl : Form
    {
        ...
        public adminControl()   ///baslangic icin yapilan atamalar
        {
            ...
            customerTextArray = new TextBox[] { tb_customerName, tb_customerAddress, tb_customerMail, tb_customerPw };
        ...
        private void btn_addBook_Click(object sender, EventArgs e)///kitap ekleme islemini gercekleyen buton
        {
            ...
            if (ImageDest != null)
            {
                string destPath = Application.StartupPath + @"\Resources\BookPictures\" + txtBookImageName.Text + ".png";
        ...
        private void btn_addMagazine_Click(object sender, EventArgs e) ///dergi ekleme islemini gercekleyen buton
        {
            ...
            if (ImageDest != null)
            {
                string destPath = Application.StartupPath + @"\Resources\MagazinePictures\" + txtMgzImageName.Text + ".png";
        ...
        private void btn_addMusic_Click(object sender, EventArgs e) ///muzikCd urunu eklemeyi saglayan buton
        {
            ...
            if (ImageDest != null)
            {
                string destPath = Application.StartupPath + @"\Resources\MusicCdPictures\" + txtMusicImageName.Text + ".png";
        ...
        private void btn_customer_update_Click(object sender, EventArgs e) ///musteri update butonunun click eventi
        {
            ...
            string kayit = "UPDATE CUSTOMER SET Name=@NAME,Address=@ADDRESS,Email=@EMAIL,Password=@PASSWORD,Purchases=@PURCHASES,IsAdmin=@ISADMIN where ID=@ID";
            connection.Open();
            ...
            cmd.Parameters.AddWithValue("Purchases", row.Cells[5].Value);
            if (cbIsRoot.Checked)
        ...
        private void dg_books_CellClick(object sender, DataGridViewCellEventArgs e) ///kitap datagridinde satir secimi
        {
            ...
            if (index != dg_books.RowCount - 1)
            {
                try
                {
                    pb_Books.Image = Image.FromFile(Application.StartupPath + @"\Resources\BookPictures\" + txtBookImageName.Text + ".png");
                }
                catch (Exception)
                {
        ...
        private void dg_magazines_CellClick(object sender, DataGridViewCellEventArgs e)///dergi datagridinde belirli bir dergiyi secmek
        {
            ...
            if (index != dg_magazines.RowCount - 1)
            {
                try
                {
                    pb_Magazines.Image = Image.FromFile(Application.StartupPath + @"\Resources\MagazinePictures\" + txtMgzImageName.Text + ".png");
                }
                catch (Exception)
                {
        ...
        private void dg_musicCD_CellClick(object sender, DataGridViewCellEventArgs e)///belirli bir music cd secme islemi, secilen albumun txtboxlara yazimi
        {
            ...
            if (index != dg_musicCD.RowCount - 1)
            {
                try
                {
                    pb_MusicCd.Image = Image.FromFile(Application.StartupPath + @"\Resources\MusicCdPictures\" + txtMusicImageName.Text + ".png");
                }
                catch (Exception)
                {
